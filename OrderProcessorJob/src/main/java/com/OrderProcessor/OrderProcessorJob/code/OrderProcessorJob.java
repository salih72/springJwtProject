package com.OrderProcessor.OrderProcessorJob.code;
...
public class OrderProcessorJob implements Runnable {
    ...
    public void run() {
        ...
        List<LoginUserDto> loginUserDtos = List.of(
                new LoginUserDto("salih@1", "123"),
                new LoginUserDto("salih@2", "123"),
                new LoginUserDto("salih@3", "123"),
                new LoginUserDto("salih@4", "123"),
                new LoginUserDto("salih@5", "123"),
                new LoginUserDto("salih@6", "123"),
                new LoginUserDto("salih@7", "123")
        );
        ...
        while (true) {
            for (String token : tokens) {
                CreateOrderRequest createOrderRequest = new CreateOrderRequest(
                        List.of(new Product(9, "Pizza", 800, 1)),
                        800,
                        "Istanbul"
                );
