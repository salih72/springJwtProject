package com.consumerapp.consumerApplication.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, OrderDto> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.consumerapp.consumerApplication.dtos");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.consumerapp.consumerApplication.dtos.OrderDto");
